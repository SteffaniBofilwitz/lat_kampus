...
import 'package:lat_kampus_apps/screen_page/page_detail_kampus.dart';
  ...
  Future<void> getKampus() async {
    try {
      http.Response response = await http
          .get(Uri.parse('http://192.168.100.137/lat_kampus_apps/getKampus.php'));
                          ...
                          children: [
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'http://192.168.100.137/lat_kampus_apps/gambar/${data?.gambarKampus}',
                                  fit: BoxFit.cover,
                                  height: 76,
                                  width: 76,
                                ),
